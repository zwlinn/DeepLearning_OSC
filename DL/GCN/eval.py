...
from GCNpkg import GCNModel, GraphDataset, collate
...
model = GCNModel(in_feats_don_node=45, in_feats_don_edge=10, 
...
predictions_df.to_excel('GCN_P.xlsx', index=False)
