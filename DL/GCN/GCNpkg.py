import dgl
from dgl.nn.pytorch import Set2Set, GraphConv
...
parser = argparse.ArgumentParser(description='GCN for PCE prediction')
...
class GCN(nn.Module):
    ...
    def __init__(self, in_feats, n_hidden, out_feats, n_layers, n_step_s2s, n_layer_s2s):
        ...
        self.layers.append(GraphConv(n_hidden//2**(n_layers-1), out_feats))
...
class GCNModel(nn.Module):
    ...
    def __init__(self, in_feats_don_node, in_feats_don_edge,
        ...
        self.don_GCN = GCN(in_feats_don_node, n_hidden, out_feats, n_layers, n_step_s2s, n_layer_s2s)
        self.acc_GCN = GCN(in_feats_acc_node, n_hidden, out_feats, n_layers, n_step_s2s, n_layer_s2s)
    ...
    def forward(self, don_graph, acc_graph):
        ...
        don_graph_feats = self.don_GCN(don_graph, don_node_feats)
        acc_graph_feats = self.acc_GCN(acc_graph, acc_node_feats)
...
def main():
    ...
    model = GCNModel(in_feats_don_node=in_feats_don_node, in_feats_don_edge=in_feats_don_edge,
