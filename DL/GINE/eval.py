...
from GINEpkg import GINEModel, GraphDataset, collate
...
model = GINEModel(in_feats_don_node=45, in_feats_don_edge=10, 
...
predictions_df.to_excel('GINE_P.xlsx', index=False)
