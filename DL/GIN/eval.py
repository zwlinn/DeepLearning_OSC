...
from GINpkg import GINModel, GraphDataset, collate
...
model = GINModel(in_feats_don_node=45, in_feats_don_edge=10, 
                 in_feats_acc_node=45, in_feats_acc_edge=10,
                 n_hidden=256, out_feats=45, n_layers=3, 
...
predictions_df.to_excel('GIN_P.xlsx', index=False)
