...
from MPNNpkg import MPNNModel, GraphDataset, collate
...
model = MPNNModel(in_feats_don_node=45, in_feats_don_edge=10, 
...
predictions_df.to_excel('MPNN_P.xlsx', index=False)
