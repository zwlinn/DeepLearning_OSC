...
from GATpkg import GATModel, GraphDataset, collate
...
model = GATModel(in_feats_don_node=45, in_feats_don_edge=10, 
...
predictions_df.to_excel('GAT_P.xlsx', index=False)
