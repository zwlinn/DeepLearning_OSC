...
from EGAT2pkg import EGATModel, GraphDataset, collate
...
model = EGATModel(in_feats_don_node=45, in_feats_don_edge=10, 
                 in_feats_acc_node=45, in_feats_acc_edge=10,
                 n_hidden=128, out_feats=45, n_layers=3, 
...
predictions_df.to_excel('EGAT_P.xlsx', index=False)
